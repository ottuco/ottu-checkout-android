...
import ottu.checkout.adapter.PaymentMethodAdapter;
import ottu.checkout.adapter.SavedCardAdapter;
import ottu.checkout.model.DeleteCard.SendDeleteCard;
import ottu.checkout.model.RedirectUrl.CreateRedirectUrl;
import ottu.checkout.model.RedirectUrl.RespoRedirectUrl;
import ottu.checkout.model.SocketData.SocketRespo;
import ottu.checkout.model.fetchTxnDetail.Card;
import ottu.checkout.model.fetchTxnDetail.PaymentMethod;
import ottu.checkout.model.fetchTxnDetail.RespoFetchTxnDetail;
import ottu.checkout.model.submitCHD.Card_SubmitCHD;
import ottu.checkout.model.submitCHD.SubmitCHDToOttoPG;
import ottu.checkout.model.submitCHD.SubmitCHDToOttoPGEncrypted;
import ottu.checkout.network.GetDataService;
import ottu.checkout.network.RetrofitClientInstance;
import ottu.checkout.util.RSACipher;
import ottu.checkout.R;
import ottu.checkout.databinding.ActivityPaymentBinding;
import retrofit2.Call;
import retrofit2.Callback;
import retrofit2.Response;

import static ottu.checkout.network.RetrofitClientInstance.getRetrofitInstance;
import static ottu.checkout.network.RetrofitClientInstance.getRetrofitInstancePg;
import static ottu.checkout.util.Constant.Amount;
import static ottu.checkout.util.Constant.AmountCurrencyCode;
import static ottu.checkout.util.Constant.ApiId;
import static ottu.checkout.util.Constant.LocalLan;
import static ottu.checkout.util.Constant.MerchantId;
import static ottu.checkout.util.Constant.NetAmount;
import static ottu.checkout.util.Constant.OttuPaymentResult;
import static ottu.checkout.util.Constant.SessionId;
import static ottu.checkout.util.Constant.SubmitUrlCard;
import static ottu.checkout.util.Constant.SubmitUrlRedirect;
import static ottu.checkout.util.Constant.UrlPublicKey;
import static ottu.checkout.util.Constant.savedCardSelected;
import static ottu.checkout.util.Constant.selectedCardPos;
import static ottu.checkout.util.Constant.selectedCardPosision;
import static ottu.checkout.util.Constant.sessionId;
import static ottu.checkout.util.RSACipher.convertObjToString;
import static ottu.checkout.util.Util.isDeviceRooted;
import static ottu.checkout.util.Util.isNetworkAvailable;
